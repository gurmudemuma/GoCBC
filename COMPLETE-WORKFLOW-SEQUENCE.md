...
### PHASE 3: NBE APPROVAL FOR FOREX

#### Step 3: NBE Portal - Approve Contract for Forex Eligibility
**Actor:** NBE Officer  
**Endpoint:** `POST /api/v1/contracts/{contractId}/nbe-approve`  
**Verification:**
- Contract value verification
- Currency requirements
- Export proceeds repatriation compliance
- Forex retention policy (40%)

**Status After:** Contract status = `NBE_APPROVED`, Forex Eligible = `true`

---

### PHASE 4: FOREX REQUEST & ALLOCATION

#### Step 4A: Exporter Portal - Submit Forex Request
**Actor:** Exporter  
...
#### Step 4B: Bank Portal - Allocate Forex (with NBE approval)
**Actor:** Bank Officer  
...
### PHASE 5: LETTER OF CREDIT (LC)

#### Step 5A: Exporter Portal - Request LC
**Actor:** Exporter  
...
#### Step 5B: Bank Portal - Review & Approve LC
**Actor:** Bank Officer  
...
### PHASE 6: SHIPMENT PREPARATION

#### Step 6: Exporter Portal - Create Shipment Record
**Actor:** Exporter  
...
#### Step 7: ECX/Lab - Quality Inspection & Certification
...
### PHASE 8: CUSTOMS CLEARANCE

#### Step 8A: Exporter Portal - Submit Customs Declaration
**Actor:** Exporter  
...
#### Step 8B: Customs Portal - Review Declaration & Schedule Inspection
...
#### Step 8C: Customs Portal - Complete Physical Inspection
...
#### Step 8D: Customs Portal - Clear Declaration & Issue Export Permit
**Actor:** Customs Officer  
...
### PHASE 9: SHIPPING & DOCUMENTATION

#### Step 9: Shipping Company - Record Shipment Details
...
### PHASE 10: SWIFT PAYMENT MESSAGES

#### Step 10A: Buyer's Bank - Issue MT700 (LC Issuance)
**Actor:** Buyer's Bank  
...
#### Step 10B: Exporter's Bank - Send MT710 (Advice of LC)
...
#### Step 10C: Exporter's Bank - Present Documents (Document Presentation)
**Actor:** Exporter's Bank  
**Documents Presented:**
...
#### Step 10D: Buyer's Bank - Send MT750 (Discrepancy Notice) [If Applicable]
**Actor:** Buyer's Bank  
**Endpoint:** `POST /api/v1/swift/messages`  
**Message Type:** MT750  
...
#### Step 10E: Buyer's Bank - Send MT103 (Customer Credit Transfer)
**Actor:** Buyer's Bank  
**Endpoint:** `POST /api/v1/swift/messages`  
**Message Type:** MT103  
**Data Required:**
...
#### Step 10F: Exporter's Bank - Send MT910 (Confirmation of Credit)
**Actor:** Exporter's Bank  
**Endpoint:** `POST /api/v1/swift/messages`  
**Message Type:** MT910  
...
### PHASE 11: PAYMENT SETTLEMENT & FOREX UTILIZATION

#### Step 11A: Bank Portal - Record Payment Settlement
**Actor:** Bank Officer  
...
#### Step 11B: Bank Portal - Mark Forex as Utilized
**Actor:** Bank Officer  
...
#### Step 11C: Bank Portal - Process Forex Retention
**Actor:** Bank Officer  
...
### 3. NBE PORTAL
- Approve contracts for forex eligibility
- Monitor forex retention compliance
...
```
DRAFT → PENDING_APPROVAL → ECTA_APPROVED → NBE_APPROVED → ACTIVE
```
...
3. ✅ NBE approval (with MSP identity)
4. ✅ Forex allocation (with MSP identity)
...
**Typical Duration:** 30-45 days from contract to payment

- **Day 0-1:** Contract creation & registration
- **Day 1-2:** ECTA approval
- **Day 2-3:** NBE approval
- **Day 3-5:** Forex allocation
- **Day 5-7:** LC issuance
